    ...
    return originClass => {
      class newClass extends originClass {
        async __$QInitModel() {
          ...
          let properties = (_Reflect$getMetadata = Reflect.getMetadata('properties', originClass)) !== null && _Reflect$getMetadata !== void 0 ? _Reflect$getMetadata : {};
          const model = selDataBaseServer.model(schemaName !== null && schemaName !== void 0 ? schemaName : originClass.name, new Schema(properties));
